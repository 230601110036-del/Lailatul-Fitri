"""
Django settings for my_ project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-j)%mfrj$3l=yy5e1a^_rk-z43luncjr%s@lj@=5%tg-%hwj8uf')
...
WSGI_APPLICATION = 'my_.wsgi.application'
